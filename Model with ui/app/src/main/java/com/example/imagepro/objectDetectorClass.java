...
public class  objectDetectorClass {
    ...
    private String get_alphabets(float sign_v) {
        ...
        if (sign_v>=0.5 & sign_v<1.5){
            val="B";
        }
        if (sign_v>=1.5 & sign_v<2.5){
            val="C";
        }
        if (sign_v>=2.5 & sign_v<3.5){
            val="D";
        }
        if (sign_v>=3.5 & sign_v<4.5){
            val="E";
        }
        if (sign_v>=4.5 & sign_v<5.5){
            val="F";
        }
        if (sign_v>=5.5 & sign_v<6.5){
            val="G";
        }
        if (sign_v>=6.5 & sign_v<7.5){
            val="H";
        }
        if (sign_v>=7.5 & sign_v<8.5){
            val="I";
        }
        if (sign_v>=8.5 & sign_v<9.5){
            val="J";
        }
        if (sign_v>=9.5 & sign_v<10.5){
            val="K";
        }
        if (sign_v>=10.5 & sign_v<11.5){
            val="L";
        }if (sign_v>=11.5 & sign_v<12.5){
            val="M";
        }
        if (sign_v>=12.5 & sign_v<13.5){
            val="N";
        }
        if (sign_v>=13.5 & sign_v<14.5){
            val="O";
        }
        if (sign_v>=14.5 & sign_v<15.5){
            val="P";
        }
        if (sign_v>=15.5 & sign_v<16.5){
            val="Q";
        }
        if (sign_v>=16.5 & sign_v<17.5){
            val="R";
        }
        if (sign_v>=17.5 & sign_v<18.5){
            val="S";
        }
        if (sign_v>=18.5 & sign_v<19.5){
            val="T";
        }
        if (sign_v>=19.5 & sign_v<20.5){
            val="U";
        }
        if (sign_v>=20.5 & sign_v<21.5){
            val="V";
        }
        if (sign_v>=21.5 & sign_v<22.5){
            val="W";
        }
        if (sign_v>=22.5 & sign_v<23.5){
            val="X";
        }
        if (sign_v>=23.5 & sign_v<24.5){
            val="Y";
        }
        return val;
    }
